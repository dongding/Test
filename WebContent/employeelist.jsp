...
.title_0{
	...
	<div style="display: none;" id="employee" class="agreementview">
		...
		"SelectAll();"/></th>						
						...
						<th id="th_icon"><div title="Refrsh" style="cursor:pointer;background-image:url('img/glyphicons-halflings.png');background-repeat:no-repeat; background-position:-240px -24px; height: 16px; width: 16px; margin-left: 20px;" ng-click="refresh()"></div>
			...
			<table class="table" style="position:relative;">
				<tbody>					
					<tr class="employee" ng-repeat="member in applications  | MyOrderBy: f : rev1 | 
					MyFilter: myfilter" id="{{member.dataId}}" style="text-align: center;">
						<td><input type="checkbox" name="choose"></td>
						<td  style="font-size:13px;text-align:left" ng-dblclick="showdetail(member.dataId)"  ng-click="focusme(member.dataId)">
							<p style="width:230px; white-space:nowrap;text-overflow:ellipsis;-o-text-overflow:ellipsis;overflow: hidden; "title={{member.trainingProgram}}  ng-bind="member.trainingProgram" id="emptp_{{member.dataId}}">
 								</p></td>
						
                        <td ng-bind="member.totalCost"; style="font-size:13px;" ng-dblclick="showdetail(member.dataId)"  ng-click="focusme(member.dataId)">as</td>
						<td ng-bind="member.companyCover";style="font-size:13px;" ng-dblclick="showdetail(member.dataId)"  ng-click="focusme(member.dataId)">as</td>
						<td ng-bind="member.servicePeriodFrom";style="font-size:13px;" ng-dblclick="showdetail(member.dataId)"  ng-click="focusme(member.dataId)"></td>						
						<td ng-bind="member.servicePeriodTo"; style="font-size:13px;" ng-dblclick="showdetail(member.dataId)"  ng-click="focusme(member.dataId)"></td>						
