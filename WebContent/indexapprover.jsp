...
<!--          					<a class="navbar-brand" href="#"><font style="font-size: 16px;">Training Tracking</font></a>-->
        				...
        				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
          					<ul class="nav navbar-nav">
           						<li class=""><a href="#">&nbsp;Home&nbsp;</a></li>
           							<li class="active"><a href="indexapprover.jsp">&nbsp;List&nbsp;</a></li>
           							<li class=""><a href="preparetoaddapplication">&nbsp;Add&nbsp;</a></li>
          					</ul>         					
	...
	$('#tbodyapprover').height($("#examp").height() - $("#theadapprover").height() - $('#selecttab').height()-70);
	//$('#tbodyemployee').css("height",$('#thodyadmin').height());

	//alert($('#tbodyadmin').height());
$("#tbodyapprover").niceScroll({  
   		cursorcolor:"gray",  
   		cursoropacitymax:1,  
   		touchbehavior:false,  
   		cursorwidth:"7px",  
