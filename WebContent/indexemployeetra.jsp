...
<!--          					<a class="navbar-brand" href="#"><font style="font-size: 16px;">Training Tracking</font></a>-->
        				...
        				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
          					<ul class="nav navbar-nav">
           						<li class=""><a href="#">&nbsp;Home&nbsp;</a></li>
           							<li class="active"><a href="showallapplication">&nbsp;List&nbsp;</a></li>
		...
		<div id="shclKeyframes" style="width: 100px;height: 100px; z-index: 100; position: absolute;top: 350px;"></div>
	  	<div class="row" id="content" style="margin-top: -5px;">
			<%@include file="employeeTrafficMain.jsp" %>
	  	</div>
